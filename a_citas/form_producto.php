	...
	?>
		...
		<div class="modal-body" style='max-height:580px;overflow: auto;'>
			<form is="b-submit" id="form_busca" des="a_citas/busca_producto" dix='resultadosx' >
				<input  type='hidden' id='idventa' NAME='idventa' value='<?php echo $id; ?>'>

				<div clas='row'>
						<div class="input-group mb-3">
						<input type="text" class="form-control" name="prod_venta" id='prod_venta' placeholder='buscar producto' aria-label="buscar producto" aria-describedby="basic-addon2" onkeyup='Javascript: if (event.keyCode==13) buscar_prodpedido(<?php echo $id2;  ?>)'>
