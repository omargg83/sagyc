<?php
	...
	foreach($pedido as $key){
		...
		if($estado=="Activa" and $key->cantidad>0){
			echo "<button class='btn btn-outline-secondary btn-sm' id='eliminar_comision' data-lugar='a_entrada/db_' data-destino='a_entrada/form_pedido' data-id='".$key->idbodega."' data-iddest='$id' data-funcion='borrar_producto' data-div='pedidos'><i class='far fa-trash-alt'></i></i></button>";
		}
