			...
			<div class='card-body'>
				<div class='row'>
					...
					<div class='col-12 col-sm-4'>
						...
						<select class="form-select form-control " name="tipoticket" id="tipoticket"required>
					...
					<div class='col-12 col-sm-4'>
						...
						<select class="form-select" name="etiqueta" id="etiqueta"required>
					...
					<div class='col-12 col-sm-4'>
						<label>Matriz:</label>
						<select class="form-select" name="matriz" id="matriz" required>
