        ...
        <div class='col-7'>
          ...
          <?php
            if($estado_compra=="Activa"){
              ...
              echo "<button type='button' class='btn btn-warning btn-sm mr-2' id='finalizar' is='b-link' v_idventa='$idventa' des='a_venta/finalizar' omodal='1'><i class='fas fa-cash-register'></i>Finalizar</button>";
            }
            else{
